-- Expand default pool chemistry definitions (Skimmer-style full catalog)
...
BEGIN
  ...
  INSERT INTO public.pool_reading_definitions (business_id, key, label, unit, sort_order) VALUES
    ...
    (p_business_id, 'total_bromine', 'Total Bromine', 'ppm', 5),
    (p_business_id, 'total_hardness', 'Total Hardness', 'ppm', 6),
    (p_business_id, 'salt', 'Salt', 'ppm', 7),
    (p_business_id, 'phosphates', 'Phosphates', 'ppb', 8),
    (p_business_id, 'tds', 'Tds', 'ppm', 9)
  ...
  INSERT INTO public.pool_dosage_definitions (business_id, key, label, unit, direction, sort_order, preset_values) VALUES
    ...
    (p_business_id, 'cyanuric_acid_dose', 'Cyanuric Acid', 'lbs', NULL, 7, '["¼","½","1"]'::jsonb),
    (p_business_id, 'phosphates_down', 'Phosphates ↓', 'oz', 'down', 8, '["4","8","16"]'::jsonb),
    (p_business_id, 'chlorine_down', 'Chlorine ↓', 'oz', 'down', 9, '["4","8","16"]'::jsonb)
  ON CONFLICT (business_id, key) DO NOTHING;
END;
$$;
